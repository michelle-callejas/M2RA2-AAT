...
<main class="container">
    ...
    <form action="agregar_cliente" method="post" >
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="txtIdCliente" id="txtIdCliente">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="txtNit" id="txtNit">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="txtContra" id="txtContra">
        </div>
